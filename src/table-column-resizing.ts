...
import { cellAround, TableMap, tableNodeTypes, updateColumnsOnResize as updateColumns } from 'prosemirror-tables';
...
export function columnResizing({ handleWidth = 5, cellMinWidth = 25, View = TableView, lastColumnResizable = true, firstResizableColumn = 0 } = {}) {
  let plugin = new Plugin({
    ...
    props: {
      ...
      handleDOMEvents: {
        mousemove(view, event) { handleMouseMove(view, event, handleWidth, cellMinWidth, lastColumnResizable, firstResizableColumn) },
